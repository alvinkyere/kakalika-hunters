...
export default function HostPage() {
  ...
  async function startSession() {
    ...
    try {
      const res = await fetch("https://kakalika-hunters.onrender.com/api/sessions", { method: "POST" });
  ...
  async function stopSession() {
    ...
    if (sessionIdRef.current) {
      await fetch(`https://kakalika-hunters.onrender.com/api/sessions/${sessionIdRef.current}`, { method: "DELETE" });
    }
    resetSession();
  }
